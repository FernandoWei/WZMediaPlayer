...
#define MAX_PKT_COUNT 200  //默认最大gop长度
        ...
        private:
            std::string virtual getClassName() const {return std::string("VideoDecoder");}
            
        private:
            Utility::PlayerState redecodeDuplicatedVideoPkt();
            Utility::PlayerState createImage();
            Utility::PlayerState enqueueImage();
            Utility::PlayerState renderImage();
            bool prepareDecoder();
