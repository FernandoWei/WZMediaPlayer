...
namespace WZ {
    ...
    namespace MediaPlayer {
        ...
        mCurrentClock(),
        mLastVideoPTS(-1),
        mDiscardFrameType(Utility::DiscardFrameType::DISCARD_NONE),
        mFirst(true)
        {
            ;
        }
        ...
        void MediaState::synchronize(int64_t pts, std::atomic_bool& stopped){
            ...
            if (delay > kMaxSyncDelay){
                if (mDiscardFrameType != Utility::DiscardFrameType::DISCARD_NONE){
                    mDiscardFrameType = Utility::DiscardFrameType::DISCARD_NONE;
                }
                ...
                if (mDiscardFrameType != Utility::DiscardFrameType::DISCARD_DEFAULT){
                    mDiscardFrameType = Utility::DiscardFrameType::DISCARD_DEFAULT;
                }
            }
        ...
        Utility::DiscardFrameType MediaState::getCurrentDiscardState(){
