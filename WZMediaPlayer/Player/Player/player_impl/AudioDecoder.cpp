...
namespace WZ {
    namespace MediaPlayer {
        ...
        Utility::PlayerState AudioDecoder::decode(AVPacket* pkt){
        ...
        Utility::PlayerState AudioDecoder::enqueueAudioPacket(const AVPacket* pkt){
            ...
            if (waitForFreeBuffer()){
                ...
                checkErrorWithReturn(err, "AudioQueueEnqueueBuffer", Utility::PlayerState::ERROR);
